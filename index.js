alert('Use following key words for traversing the snake \n Q A ArrowU ArrowD ArrowR ArrowL');
...
var BACKGROUND_COLOR = 0xdeeaee, BODY_COLOR = 0x388e3c, HEAD_COLOR = 0x004D40, score = 0;
...
function init(){
    ...
    detail.style.top=60+"px";
    detail.style.left=60+"px;"
    detail.style.fontSize = 50 + "px";*/
...
function restart(){
    ...
    for(var i = 0; i < snake.length; i++){
        snake[i].setPosition(
            (i + i * padding) -halfCubeSize + 0.5 , 0.5 + padding / 2, 0.5 + padding / 2 
        );
    }
    end = false;
